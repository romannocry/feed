...
def process_payload(payload: Dict) -> Dict:
    ...
    if storage := payload.get("storage"):
        post_to_storage(payload.get("storage"),
            {
...
if __name__ == "__main__":
    ...
    b64payload = ""
